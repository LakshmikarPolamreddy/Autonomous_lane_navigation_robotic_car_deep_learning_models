...
class EndToEndLaneFollower(object):
    ...
    def __init__(self,
                 car=None,
                 model_path='/home/pi/DeepPiCar/models/lane_navigation/data/model_result/lane_navigation_final_custom_model.h5'):
...
if __name__ == '__main__':
    ...
    test_video('/home/pi/DeepPiCar/driver/data/tmp/train_3')
